...
INSERT INTO profiles (id, email, username, gender, fitness_level, training_days_per_week, weight, height, age, goal, archetype, current_streak, longest_streak, last_check_in_date, onboarding_complete)
VALUES (
  'USER_ID_BRO_MID',
  'bro.mid@test.welltrained.app',
  'BRO_FORGED',
  'male', 'intermediate', 4, 185, 71, 28, 'recomp', 'bro',
  45, 52, CURRENT_DATE, true
) ON CONFLICT (id) DO UPDATE SET current_streak = 45, longest_streak = 52, username = 'BRO_FORGED', archetype = 'bro';
...
VALUES (
  ...
  'BRO_MASTER',
  'male', 'advanced', 5, 195, 72, 32, 'bulk', 'bro',
  180, 180, CURRENT_DATE, true
) ON CONFLICT (id) DO UPDATE SET current_streak = 180, longest_streak = 180, username = 'BRO_MASTER', archetype = 'bro';
...
VALUES (
  ...
  'HIMBO_HARDENED',
  'male', 'intermediate', 4, 175, 70, 25, 'maintain', 'himbo',
  21, 35, CURRENT_DATE, true
) ON CONFLICT (id) DO UPDATE SET current_streak = 21, longest_streak = 35, username = 'HIMBO_HARDENED', archetype = 'himbo';
...
VALUES (
  ...
  'HIMBO_MASTER',
  'male', 'advanced', 5, 180, 69, 27, 'recomp', 'himbo',
  120, 145, CURRENT_DATE, true
) ON CONFLICT (id) DO UPDATE SET current_streak = 120, longest_streak = 145, username = 'HIMBO_MASTER', archetype = 'himbo';
...
VALUES (
  ...
  'BRUTE_TRUSTED',
  'male', 'intermediate', 5, 220, 74, 30, 'bulk', 'brute',
  60, 60, CURRENT_DATE, true
) ON CONFLICT (id) DO UPDATE SET current_streak = 60, longest_streak = 60, username = 'BRUTE_TRUSTED', archetype = 'brute';
...
VALUES (
  ...
  'BRUTE_MASTER',
  'male', 'advanced', 5, 235, 75, 34, 'bulk', 'brute',
  200, 200, CURRENT_DATE, true
) ON CONFLICT (id) DO UPDATE SET current_streak = 200, longest_streak = 200, username = 'BRUTE_MASTER', archetype = 'brute';
...
VALUES (
  ...
  'PUP_PROVEN',
  'male', 'beginner', 3, 155, 67, 23, 'cut', 'pup',
  14, 28, CURRENT_DATE, true
) ON CONFLICT (id) DO UPDATE SET current_streak = 14, longest_streak = 28, username = 'PUP_PROVEN', archetype = 'pup';
...
VALUES (
  ...
  'PUP_MASTER',
  'male', 'intermediate', 4, 165, 68, 26, 'recomp', 'pup',
  90, 110, CURRENT_DATE, true
) ON CONFLICT (id) DO UPDATE SET current_streak = 90, longest_streak = 110, username = 'PUP_MASTER', archetype = 'pup';
...
VALUES (
  ...
  'BULL_ENFORCER',
  'male', 'advanced', 5, 210, 73, 29, 'recomp', 'bull',
  75, 82, CURRENT_DATE, true
) ON CONFLICT (id) DO UPDATE SET current_streak = 75, longest_streak = 82, username = 'BULL_ENFORCER', archetype = 'bull';
...
VALUES (
  ...
  'BULL_MASTER',
  'male', 'advanced', 5, 225, 74, 35, 'maintain', 'bull',
  250, 250, CURRENT_DATE, true
) ON CONFLICT (id) DO UPDATE SET current_streak = 250, longest_streak = 250, username = 'BULL_MASTER', archetype = 'bull';
...
-- VERIFY
-- =============================================
SELECT p.username, p.archetype, p.current_streak, x.total_xp, x.current_level
FROM profiles p
