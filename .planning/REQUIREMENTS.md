...
- [x] **SHARE-08**: Workouts shows "Share Protocol" button on completed workouts
...
- [x] **WRPT-06**: Share button produces weekly report share card
...
- [x] **REFR-03**: Referrer earns 100 DP when recruit completes first week (7 days with DP actions)
